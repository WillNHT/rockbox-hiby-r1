...
#define TAG(type,name,param,flag) {(type),sizeof(name),(name "\0" param),(flag)}
    ...
    TAG(SKIN_TOKEN_ANIMATION_FRAME,       "an", "II", SKIN_REFRESH_PEAK_METER),
    TAG(SKIN_TOKEN_STICK_DIAL_ARMED,      "sd", "", SKIN_REFRESH_DYNAMIC),
    TAG(SKIN_TOKEN_PLAYLIST_COVER,        "Cp", "III",
        SKIN_REFRESH_STATIC|SKIN_REFRESH_PEAK_METER),
    TAG(SKIN_TOKEN_PLAYLIST_COVER_FOUND,  "CP", "", SKIN_REFRESH_STATIC),
    TAG(SKIN_TOKEN_LYRICS_LINE,           "yl", "|i", SKIN_REFRESH_DYNAMIC),
    TAG(SKIN_TOKEN_LYRICS_FOUND,          "yf", "", SKIN_REFRESH_DYNAMIC),
    TAG(SKIN_TOKEN_LYRICS_BLOCK,          "yb", "IIII|sSI",
        SKIN_REFRESH_DYNAMIC|SKIN_REFRESH_PEAK_METER),
    TAG(SKIN_TOKEN_LYRICS_PROGRESS,       "yp", "", SKIN_REFRESH_DYNAMIC),
    TAG(SKIN_TOKEN_VIDEO_ART,             "Cv", "IIII|S",
        SKIN_REFRESH_STATIC|SKIN_REFRESH_PEAK_METER),
    TAG(SKIN_TOKEN_VIDEO_ART_KIND,        "CV", "", SKIN_REFRESH_DYNAMIC),
    TAG(SKIN_TOKEN_VIDEO_CLIP,            "Cf", "IIIIF|S",
        SKIN_REFRESH_STATIC|SKIN_REFRESH_PEAK_METER),
    TAG(SKIN_TOKEN_ALBUMART_BACKDROP,     "Cb", "IIIIII",
        SKIN_REFRESH_STATIC|SKIN_REFRESH_DYNAMIC),
    TAG(SKIN_TOKEN_ALBUMART_MIRROR,       "Cm", "IIIIII",
        SKIN_REFRESH_STATIC|SKIN_REFRESH_DYNAMIC),
    /* Refreshed with the animations: it turns. */
    TAG(SKIN_TOKEN_ALBUMART_VINYL,        "Cr", "IIIIII|S",
        SKIN_REFRESH_PEAK_METER),
    TAG(SKIN_TOKEN_PEAKMETER,             "pm", "|I", SKIN_REFRESH_PEAK_METER),

...
*   **Backlight:** normal, dimmed and off, each with its own timer, and dim levels in 0.5 % steps. A key press or a tap on a dimmed or dark screen only wakes it (taps do nothing while input is locked).

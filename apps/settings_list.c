...
# ifdef HAVE_HEADPHONE_DETECTION
   ...
   TEXT_SETTING(0, audiobook_wps, "audiobook wps", "", NULL, NULL),
   INT_SETTING(F_TIME_SETTING, ab_rewind_after, LANG_AB_REWIND_AFTER, 1,
               "audiobook rewind after", UNIT_MIN, 0, 60, 1,
               formatter_time_unit_0_is_off, getlang_time_unit_0_is_off, NULL),
   INT_SETTING(F_TIME_SETTING, ab_rewind_amount, LANG_AB_REWIND_AMOUNT, 60,
               "audiobook rewind amount", UNIT_SEC, 0, 300, 5,
               formatter_time_unit_0_is_off, getlang_time_unit_0_is_off, NULL),
   INT_SETTING(0, ab_finished_pct, LANG_AB_FINISHED_AT, 97,
               "audiobook finished percent", UNIT_PERCENT, 50, 100, 1,
               NULL, NULL, NULL),
   ...
   TEXT_SETTING(0, radio_last, "radio last station", "", NULL, NULL),
   ...
   OFFON_SETTING(0, radio_static, LANG_RADIO_STATIC, true,
                 "radio static", NULL),
   INT_SETTING(0, radio_static_strength, LANG_RADIO_STATIC_STRENGTH, 100,
               "radio static strength", UNIT_PERCENT, 10, 200, 10,
               NULL, NULL, NULL),
   OFFON_SETTING(0, radio_ambience, LANG_RADIO_AMBIENCE, true,
                 "radio band noise", NULL),

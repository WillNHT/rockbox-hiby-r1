...
#define MPEG_START_TIME_SELECT      BUTTON_RIGHT
#define MPEG_START_TIME_LEFT        (BUTTON_POWER|BUTTON_LEFT)
#define MPEG_START_TIME_RIGHT       (BUTTON_POWER|BUTTON_RIGHT)
#define MPEG_START_TIME_UP          BUTTON_UP
#define MPEG_START_TIME_DOWN        BUTTON_DOWN
#define MPEG_START_TIME_LEFT2       BUTTON_MIDLEFT
#define MPEG_START_TIME_RIGHT2      BUTTON_MIDRIGHT
#define MPEG_START_TIME_EXIT        BUTTON_LEFT
